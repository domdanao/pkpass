...
class PKTemplate {
	...
	// Obtain names of keys for various fields
	// If any of the $PKFields is specified as selector, returns keys of specified PKField
	// If selector is empty, returns ALL keys for ALL PKFields 
	...
	// Set a top-level key
	// Refer to iOS 6 Passbook documentation for mandatory keys
	...
	// List the files included in the path
